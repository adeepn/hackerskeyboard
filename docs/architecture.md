...
создал hermetic-ish bridge toolchain на JDK 17, не зависящий от локального
JDK 26. В S2.02 проектный JDK поднят до 21 вместе с AGP 9.3.1 из-за Java 21 API
встроенного lint detector.
