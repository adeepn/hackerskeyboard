...
require_coordinate "androidx.preference:preference:1.2.1" "$report_dir/debug-runtime.txt"
...
echo "Resolved AndroidX dependencies verified: Core 1.19.0; Preference 1.2.1; runner 1.7.0; JUnit 1.3.0"
